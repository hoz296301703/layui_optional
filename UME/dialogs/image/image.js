...
//                }
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            url=url + (url.indexOf("?") == -1 ? "?" : "&") + "editorid="+me.editor.id + "&merchantId="+$('#header #userName').attr('data-id');//初始form提交地址传商户id
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                $('<iframe name="up"  style="display: none"></iframe>').insertBefore(me.dialog).on('load', function(){
                    // console.info(this.contentWindow);
                    // console.info(this);
                    // console.info(this.document.body);
                    // console.info(this.document.body); 
