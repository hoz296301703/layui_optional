    ...
    E = function(e) {
      ...
      return (
        ...
        [
          ...
          '{{# if(d.data.skin){ }}lay-skin="{{d.data.skin}}"{{# } }} {{# if(d.data.limit){ }}lay-limit="{{d.data.limit}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>',
          "<thead>",
        ...
        switch (
          ...
          case "LAYTABLE_PRINT":
            var u = window.open("打印窗口", "_blank"),
              h = [
                "<style>",
                "body{font-limit: 12px; color: #666;}",
                "table{width: 100%; border-collapse: collapse; border-spacing: 0;}",
                "th,td{line-height: 20px; padding: 9px 15px; border: 1px solid #ccc; text-align: left; font-limit: 12px; color: #666;}",
        ...
        (a.tipsIndex = l.tips(
          [
            '<div class="layui-table-tips-main" style="margin-top: -' +
              ...
              (function() {
                return "sm" === o.limit
                  ? "padding: 4px 15px; font-limit: 12px;"
                  : "lg" === o.limit
                  ? "padding: 14px 15px;"
                  : "";
              })() +
